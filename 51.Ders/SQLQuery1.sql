...
INSERT INTO Musteriler (MusteriSoyad,Adres,MailAdres,Telefon,Vip) VALUES 
('Tuna', 'Kadıköy / İstanbul', 'tugaytuna@outlook.com.tr', '055555555',1)
...
CREATE VIEW VipSiparisRaporu
AS
SELECT TOP(3) U.UrunAdi, U.Fiyat, M.MusteriAd, Adet, SiparisTarihi, U.Fiyat * S.Adet AS 'Toplam Fiyat'
FROM Siparisler S
INNER JOIN Urunler U
...
SELECT UrunAdi, MusteriAd, Adet, 'Toplam Fiyat' FROM VipSiparisRaporu